  ...
  return (
    <AppWrapper>
      ...
      <CheckeredBackground>
        ...
        <DesktopIcon name="folder" to="https://twitter.com/blairwitch_eth" label="Twitter" top={50} right={50} />
        <DesktopIcon name="save" to="https://github.com/eblairmckee" label="Github" top={200} right={50} />
        <DesktopIcon
          name="garbage"
          ...
          right={50}
        />
        <Window title="Welcome" top={100} left="min(5vw, 100px)" width="min(90vw, 500px)">
          <h1>👋🏼 Hey, I'm Blair!</h1>
          <h2>I'm a frontend software engineer based in Chicago. </h2>
          <p>
            I learned everything I know from podcasts and online courses. I'm a reformed Creative Writing major who
            realized the starving artist lifestyle doesn't fit me (I'm a glutton for vegan food).
          </p>
          <p>
            Right now, I'm building the design system for Coinbase. On the side I've been deep diving React Native
            animations, GraphQL, and dipping my toes into Web3.{' '}
          </p>
        </Window>
